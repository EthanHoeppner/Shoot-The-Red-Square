...
public class ShootTheRedSquare extends PApplet {
...
public void draw()
{
  ...
  rect((player_x-7.0f)*w_scale-camera_x*w_scale, (player_y-7.0f)*w_scale-camera_y*w_scale, 14.0f*w_scale, 14*w_scale);
...
public void bullets_draw()
{
  ...
  for (int i=0; i<PlayerBullets.size(); i++)
  {
    ...
    case 0:
      fill(200);
      ellipse(bullet.x*w_scale-camera_x*w_scale, bullet.y*w_scale-camera_y*w_scale, 8.0f*w_scale, 8.0f*w_scale);
      break;
    case 1:
      fill(255, 0, 0);
      ellipse(bullet.x*w_scale-camera_x*w_scale, bullet.y*w_scale-camera_y*w_scale, 20.0f*w_scale, 20.0f*w_scale);
      break;
    case 2:
      fill(255, 100, 0);
      ellipse(bullet.x*w_scale-camera_x*w_scale, bullet.y*w_scale-camera_y*w_scale, 14.0f*w_scale, 14.0f*w_scale);
      break;
    case 3:
      fill(100, 255, 100);
      ellipse(bullet.x*w_scale-camera_x*w_scale, bullet.y*w_scale-camera_y*w_scale, 12.0f*w_scale, 12.0f*w_scale);
      break;
    }
  }
}

public void destroy_bullet(int index)
{
...
public void boss_bullets_move()
{
  for (int i=0; i<BossBullets.size(); i++)
  {
    ...
    if (point_collide(bullet.x, bullet.y) || sqrt((bullet.x-player_x)*(bullet.x-player_x)+(bullet.y-player_y)*(bullet.y-player_y))<bullet.size*0.5f)
    {
...
public void boss_bullets_draw()
{
  ...
  for (int i=0; i<BossBullets.size(); i++)
  {
    ...
    ellipse(bullet.x*w_scale-camera_x*w_scale, bullet.y*w_scale-camera_y*w_scale, bullet.size*w_scale*0.5f, bullet.size*w_scale*0.5f);
  }
}

public void fillers_move()
{
...
public void knockback(float x, float y, float mag)
{
  float dx=x-player_x;
  float dy=y-player_y;
...
public boolean terrain_collide(float x1, float y1, float x2, float y2)
{
...
public boolean point_collide(float x, float y)
{
  int grid_x=(int)(x/10);
  int grid_y=(int)(y/10);
  if (grid_x<0)
...
class Pickup
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ShootTheRedSquare" };
    if (passedArgs != null) {
